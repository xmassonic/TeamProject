    ...
    function createInstance(initJson) {
      var api = {
        apiActions: {
          ...
          getUserProfileImage: "/_api/account-info-server/profileimage",
        ...
        globalParams: {
          ...
          languages: {"en": "en", "es": "es", "pt": "pt", "fr": "fr", "ru": "ru", "de": "de", "pl": "pl", "it": "it", "ja": "ja", "ko": "ko", "tr": "tr", "nl": "nl", "da": "da", "no": "no", "sv": "sv"},
          loadingObj: "body",
          usersDomain: "",
          i: 0,
          jsonpTimeOut: 2500,
        ...
        init: function (initJson) {
          ...
          this.urlParams.urlThatUserRedirectedFrom = initJson.urlThatUserRedirectedFrom && initJson.urlThatUserRedirectedFrom.indexOf("$") == -1 ? encodeURIComponent(initJson.urlThatUserRedirectedFrom) : encodeURIComponent(document ? (document.location.protocol + '//' + document.location.host + document.location.pathname) : "");
      ...
      var returnObj = {
        ...
        getUserProfileImage: function (onError, onSuccess) {
          api.userAction("getUserProfileImage", null, onError, onSuccess);
        },
        ...
        logout: function () {
          var domain = window.location.href.split('//').pop().split('/')[0];
          var signOutUrl = 'http://www.' + domain.split('.').slice(1).join('.') + '/signout';
